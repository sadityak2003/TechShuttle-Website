  ...
  return (
    <section className="events--section" id="Events">
      <div className="events--container-box">
        ...
        <div>
          <button className="btn btn-insta" onClick={() => window.open("https://www.instagram.com/techshuttlebvp/ ")}>
            <svg
              xmlns="https://www.instagram.com/techshuttlebvp/ "
              width="32"
              height="32"
              viewBox="0 0 33 33"
              fill="none"
      ...
      <div className="events--section--container">
        {data?.events?.map((item, index) => (
          <div key={index} className="events--section--card">
            ...
            <div className="events--section--card--content">
              ...
              <p className="text-sm events--link">
                {item.link}
                <a href="https://www.instagram.com/techshuttlebvp/">
                <svg
